...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
    ...
    $query = "UPDATE menu_items SET name='$name', description='$description', price=$price, category='$category', image='$image' WHERE id=$id";
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 2rem;"><?php echo $item['image']; ?></td>
                    ...
                    <tr>
                        <td colspan="7" style="padding: 0; border: none;">
                            <div id="edit-form-<?php echo $item['id']; ?>" class="edit-form">
                                <h3 style="margin-bottom: 15px; color: var(--black);">Edit Menu Item</h3>
